...
A much computationally cheaper process would be to utilize a 2D conformer of the molecule generated by RDkit, which is the behavior of the initial MAT code if a given 3D conformer could not be computed.
